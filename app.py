...
intents = json.loads(open('datasetsamsat.json', encoding='utf-8').read())
...
def get_responses(ints, intents_json):
    ...
    return responses if responses else ["Maaf, saya tidak memahami pertanyaan Anda. Silakan coba lagi🤗"]
...
def get_bot_response():
    ...
    if responses and len(responses) > 0:
        ...
        responses = ["Maaf, saya tidak memahami pertanyaan Anda. Silakan coba lagi."]
